...
const ServiceSection = () => {
    return <section className="p-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 md:m-10 gap-x-8 gap-y-14">
            <ServiceCard icon="/develop.svg" serviceName="Developement">
            ...
            <ServiceCard icon="/architecture.svg" serviceName="Architecture">
            ...
            <ServiceCard icon="/cloud.svg" serviceName="Cloud">
            ...
            <ServiceCard icon="/devops.svg" serviceName="Dev(Sec)Ops">
            ...
            <ServiceCard icon="/training.svg" serviceName="Training">
            ...
            <ServiceCard icon="/advisor.svg" serviceName="Advisory">
