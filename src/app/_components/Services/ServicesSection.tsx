    ...
    return <section className="p-8 bg-gradient-primary">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 md:m-10 gap-10 justify-items-center">
            ...
            <ServiceCard icon="/img/cloud.svg" serviceName="Cloud">
                ...
                <br/><br/>
                <span className="font-semibold">Migration</span>: Smoothly transition your systems to the cloud, <span
            ...
            <ServiceCard icon="/img/devops.svg" serviceName="Dev(Sec)Ops">
                ...
                className="font-semibold">DevOps solutions</span> for quick and reliable application and infrastructure
                deployment.
            </ServiceCard>
            <ServiceCard icon="/img/training.svg" serviceName="Training">
                <span className="font-semibold">Comprehensive training on current technologies</span> adapted to your
                needs.
                <br/><br/>
            ...
            <ServiceCard icon="/img/advisor.svg" serviceName="Advisory">
                ...
                <br/><br/>
                Impact analysis and <span className="font-semibold">strategic recommendations</span> to align technology
