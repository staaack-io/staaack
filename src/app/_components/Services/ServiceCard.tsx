...
const ServiceCard = (props: any) => {
    return <div className="relative group w-10/12 md:w-full lg:w-9/12">
        <div
        ...
        <div
            className="h-full relative p-10 bg-white ring-1 ring-gray-900/5  leading-none flex items-top justify-start flex-col rounded-xl">
