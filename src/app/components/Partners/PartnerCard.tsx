    ...
    return <>
        {(props.selectedSectionPartner == props.category || props.selectedSectionPartner == "All") &&
            <div className="flex flex-col justify-center items-center p-5">
                <div
                    className="h-full grayscale hover:grayscale-0 hover:drop-shadow-lg hover:transform-gpu duration-500">
                    <div
                        className="h-full p-8 hover:bg-white flex justify-center items-center rounded-3xl">
