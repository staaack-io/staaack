...
const CardMe = (props: any) => {
    return <div className={props.className +
        ...
        <div className="flex flex-col gap-2 rounded-3xl w-full h-full overflow-x-auto">
            ...
            <p className="p-3">
                Bonjour ! Je suis Alexis, <b>freelance en développement et architecture logicielle</b>, basé au Luxembourg.
                <br/><br/>
                Fort de plus d&#8217;une décennie d&#8217;expérience, j&#8217;ai passé <b>6 ans en tant qu&#8217;architecte de
                ...
                je suis également disponible pour offrir des conseils en <b>DevOps</b> et pour <b>dispenser des formations</b> en développement.
                <br/><br/>
                Pour toute collaboration ou question, je vous invite à prendre rendez-vous via <a href="https://meetings-eu1.hubspot.com/alexis-detrie" target="_blank"> HubSpot</a> ou me contacter
