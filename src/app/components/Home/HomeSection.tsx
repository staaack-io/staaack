    ...
    >
      <div className='default-size z-0 grid grid-cols-12 gap-5 gap-y-12 pt-24 lg:pt-0'>
        <div className='col-span-12 flex flex-col justify-center gap-5 p-5 sm:p-0 lg:col-span-4 xl:col-span-5'>
          ...
          >
            <h1 className='font-shadow-logo font-logo absolute inline-block bg-clip-text font-extrabold text-transparent'>
              staaack
            </h1>
            <h1 className='font-color-logo font-logo absolute inline-block bg-clip-text font-extrabold text-transparent'>
              staaack
            </h1>
          </motion.div>
